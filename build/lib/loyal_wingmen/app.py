...
from utils.factories.callback_factory import gen_eval_callback
...
eval_callback = gen_eval_callback(env, "/log", "/models", eval_freq=1000)
...
model.learn(total_timesteps=10_000, reset_num_timesteps=False, callback=eval_callback)
