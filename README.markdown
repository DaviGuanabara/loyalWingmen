...
This diagram shows the relationships between functions in the DemoEnvironment class. Each function is connected to the functions it calls or depends on. The diagram helps visualize the control and data flow between different class parts.
