...
class Training:
    ...
    def execute(self, topology, log_name):
        n_envs = 4
        nn_t = topology
...
for i in range(10):
    ...
    for _ in range(randint(3, 10)):  # número de camadas variáveis
        ...
        # topology = [randint(16, 1000), randint(16, 1000), randint(16, 1000)]
    # TODO verificar formas melhores de nomear o log
    log_name = str(i)
    ...
    for _ in range(
        ...
        best_mean_reward = trainer.execute(topology, log_name)
        result_list = np.append(result_list, (best_mean_reward, topology))
