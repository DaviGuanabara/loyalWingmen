...
from .level01_simulation import (
    PIDDOCARASimulator as Level1Simulation,
)


class PIDDOCARAEnvironment(Env):
    """
        ...
        key_map.update(
            {
                ...
                Key.left: [-1, 0, 0, 1],
                Key.right: [1, 0, 0, 1],
                keycode.from_char("w"): [0, 0, 1, 1],
                keycode.from_char("s"): [0, 0, -1, 1],
            }
        )
